  ...
  return (
    <div className="refund-policy-container">
      ...
      <p>
        ...
        <p>
          These Website Standard Terms and Conditions written on this webpage
          shall manage your use of our website, Skill to learn accessible at
          skilltolearn.online.
        </p>
        <p>
          ...
          any of these Website Standard Terms and Conditions. These Terms and
          Conditions have been generated with the help of the Terms And
          Conditions Sample Template.
        </p>
        <p>
        ...
        <p>
          Other than the content you own, under these Terms, skill to learn
        ...
        <p>
          ...
          you andskill to learn may further restrict access by you to any areas
        ...
        <p>
          ...
          display on this Website. By displaying Your Content, you grant skill
          to learn a non-exclusive, worldwide irrevocable, sublicensable license
        ...
        <p>
          ...
          third-party's rights.skill to learn reserves the right to remove any
          of Your Content from this Website at any time without notice.
        </p>
        <h2>No warranties</h2>
        <p>
          This Website is provided "as is," with all faults, and skill to learn
        ...
        <p>
          In no event shall skill to learn , nor any of its officers, directors
          ...
          under contract. skill to learn , including its officers, directors and
        ...
        <p>
          You hereby indemnify to the fullest extentskill to learn from and
        ...
        <p>
          skill to learn is permitted to revise these Terms at any time as it
          sees fit, and by using this Website you are expected to review these
          Terms on a regular basis.
        </p>
        <h2>Assignment</h2>
        <p>
          Theskill to learn is allowed to assign, transfer, and subcontract its
        ...
        <p>
          These Terms constitute the entire agreement between skill to learn and
      ...
      <p>
        ...
        Conditions have been generated with the help of the Terms And Conditions
        Sample Template.
      </p>
      <p>
      ...
      <h2>Intellectual Property Rights</h2>
      <p>
        Other than the content you own, under these Terms, skill to learn and/or
      ...
      <p>
        ...
        and skill to learn may further restrict access by you to any areas of
      ...
      <p>
        In these Website Standard Terms and Conditions, "Your Content" shall
        mean any audio, video text, images or other material you choose to
        display on this Website. By displaying Your Content, you grant skill to
        learn a non-exclusive, worldwide irrevocable, sublicensable license to
      ...
      <p>
        ...
        rights. skill to learn reserves the right to remove any of Your Content
      ...
      <p>
        In no event shall skill to learn , nor any of its officers, directors
        and employees, be held liable for anything arising out of or in any way
        connected with your use of this Website whether such liability is under
        contract. skill to learn , including its officers, directors and
        employees, shall not be held liable for any indirect, consequential or
        special liability arising out of or in any way related to your use of
        this Website.
      </p>
      ...
      <h2>Indemnification</h2>
      <p>
        You hereby indemnify to the fullest extent skill to learn from and
        against any and/or all liabilities, costs, demands, causes of action,
      ...
      <h2>Variation of Terms</h2>
      <p>
        skill to learn is permitted to revise these Terms at any time as it sees
      ...
      <h2>Entire Agreement</h2>
      <p>
        These Terms constitute the entire agreement betweenskill to learn and
        you in relation to your use of this Website, and supersede all prior
        agreements and understandings.
      </p>
