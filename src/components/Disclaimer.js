    ...
    <div className="refund-policy-container">
      ...
      <ul>
        <li>
          ...
          this Disclaimer) refers to Skill to learn.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Skill to learn, accessible from{" "}
          <a
            href="https://skilltolearn.online/"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://skilltolearn.online/
          </a>
        </li>
      </ul>
      <h2>Disclaimer</h2>
